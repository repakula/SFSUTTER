...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <customApplicationComponents>
        ...
        <customApplicationComponent>EmailToCaseNotification</customApplicationComponent>
    </customApplicationComponents>
    <defaultLandingTab>standard-home</defaultLandingTab>
    <description>Service Console With Email Alerts Console Component</description>
    ...
    <footerColor>#F6F6F6</footerColor>
    <headerColor>#EDF2F4</headerColor>
    ...
    <primaryTabColor>#D9EDF3</primaryTabColor>
    ...
    <tab>SHP_Search_Offshore</tab>
    <tab>KM_Feedback_Item__c</tab>
    <tab>Adhoc_Issue__c</tab>
    <tab>Result_Log__c</tab>
    <tab>Managers_Feedback__c</tab>
    <tab>Training_Request_Form</tab>
    <tab>SHP_Internal_Service_Request</tab>
    <tab>PHI_PCI_Data__c</tab>
    ...
    <tab>New_Internal_Service_Request</tab>
    <tab>SHP_Benefit_Grid__c</tab>
    <tab>Survey_Feedback__c</tab>
    <tab>Potential_Quality_Issue__c</tab>
    <tab>SHPInternalServiceRequest</tab>
