...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>Used to validate the Provider Data.</description>
    ...
    <label>Physician Data Integrity</label>
    <listPlacement>
        <location>full</location>
    </listPlacement>
    <listRefreshMethod>none</listRefreshMethod>
    <saveUserSessions>true</saveUserSessions>
    <tab>Provider_Validation</tab>
    <tab>Providers_By_Phone_Number</tab>
    <tab>EAF_Facilities</tab>
    <tab>Assign_Records_to_Agents</tab>
